  ...
  try {
    const response = await fetch("/api/orders", {
      ...
      body: JSON.stringify({
        ...
        ],crypto_amount: document.getElementById('crypto_amount').value,
      }),
    });
...
async function onBoard() {
  try {
    ...
    console.error(error);
    resultMessage(`Could not initiate PayPal OnBoarding...<br><br>${error}`);
  }
}
...
// Clicking SignUp
document.querySelector("#onboard").addEventListener('click', (event) => {
  onBoard();
});
